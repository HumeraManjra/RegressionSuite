...
public class JMB_COUserMgt_015 
//This test is testing whether an employer can click message box filed button and entered the valid 100 character only.
{
WebDriver driver;
	...
	@Test(priority = 3)
	public void  InviteUser_EnterMax100charInMsgTextbox_Positive()  
		{
		...
		driver.findElement(By.xpath("//textarea[@id='job-description']")).sendKeys("12345123451234512345123451234512345123451234512345123451234512345123451234512345123451234512345");
		driver.findElement(By.xpath("//button[contains(text(),'INVITE USER')]")).click();
		//Assertion can not be added as there is a bug and it does not redirect to another url/page
