...
public class JMB_COUserMgt_011 
//This test is testing whether an employer can click on email button field and enter the valid email address on it
{
	WebDriver driver;
	...
	@Test(priority = 3)
			public void InviteUser_VerifyUser_Able_To_Enter_ValidEmail()
				{
